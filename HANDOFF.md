...
**最終更新**: 2026-06-11（第11セッション・プレミアム訴求強化＋医療免責事項/利用規約ページ新設）
...
また医療情報サービスとしての法的対策として、免責事項・利用規約ページ（/terms = src/app/terms/page.tsx）を
新設し、(1)/termsページ＝法的本体、(2)プロモパネル＋設定登録画面に購入前の免責文・同意みなし文言、
(3)プレミアム閲覧時（OwnerFilterTabs）に一文の注意書き、の3層で配置しました。
※免責文は一般的に妥当な内容ですが、最終的には弁護士確認を推奨する旨をユーザーに伝え済み。
最新コミット: b3c32cd
