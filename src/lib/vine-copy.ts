...
// ⚠️ ポーズを取る文は落ちる。1行ごとに、読む前は知らなかった事実をひとつ運ぶこと
// （2026-08-03・詩的な候補が全部「微妙」だった原因）。
// 「葉が1枚ひらくと2mm」は正典の"世界の一文"なので、規則の引用であって説明ではない。
export const INTRO_LINES: readonly string[] = [
  '学んだ回数が そのまま蔓の高さになる',
  '葉が一枚ひらくと 2mmのびる——読む・書く・思い出すたび',
  'アリ5mm 湯のみ7cm 鳥居5m——越えた実物が目盛りになる',
  '葉200枚から 一枚あたりの伸びが増えていく',
]
