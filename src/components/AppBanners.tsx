...
export const ANNOUNCEMENTS: Announcement[] = [
  {
    ...
    date: '2026-07-19',
    Icon: Gift,
    title: '公開記念キャンペーン：無料お試し期間をのばしています（8/18まで）',
    body: '公開を記念して、8月18日までに始めた方の無料期間を延長しています。アカウント登録だけで7日間（通常3日）、noteの特典コードで30日間（通常14日）、カード登録の無料トライアルは2週間です。また、友達紹介も始まりました。設定 → プレミアムDB設定にあるあなたの紹介コードを友達に伝えると、お相手は30日間の無料お試し、あなたのプレミアム期間も14日のびます。',
  },
  {
    ...
    body: 'アカウント登録（無料）するだけで、専門医が配信するプレミアムナレッジをそのまま閲覧できます。コード入力は不要です。noteの特典コードをお持ちの方は、設定 → プレミアムで入力するとお試し期間が延長されます。',
  },
  {
