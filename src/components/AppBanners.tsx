...
export const ANNOUNCEMENTS: Announcement[] = [
  {
    ...
    body: '公開を記念して、8月18日までに始めた方の無料期間を延長しています。アカウント登録だけで7日間（通常3日）、noteの特典コードで30日間（通常21日）、カード登録の無料トライアルは2週間です。また、友達紹介も始まりました。設定 → プレミアムDB設定にあるあなたの紹介コードを友達に伝えると、お相手は2週間の無料お試し、あなたのプレミアム期間も14日のびます。',
  },
  {
